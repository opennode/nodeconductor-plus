...
PERMISSION_LOGICS = (
    ('azure.AzureService', FilteredCollaboratorsPermissionLogic(
    ...
    ('azure.AzureServiceProjectLink', FilteredCollaboratorsPermissionLogic(
        collaborators_query=[
    ...
    ('azure.VirtualMachine', FilteredCollaboratorsPermissionLogic(
